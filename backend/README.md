...
## Project Structure
    ...
    ├── testing_world_appli_39328  # Django project configurations
...
1. Clone this repo and `cd testing_world_appli_39328`
...
2. Clone this repo and `cd testing_world_appli_39328`
